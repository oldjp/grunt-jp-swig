define(function() {
    ...
    this["SWIG"]["test/fixtures/loops.swig"] = function(data) {
        return window.swig.run(function(_swig, _ctx, _filters, _utils, _fn) {
    ...
    this["SWIG"]["test/fixtures/simple.swig"] = function(data) {
        return window.swig.run(function(_swig, _ctx, _filters, _utils, _fn) {
            var _ext = _swig.extensions,
                _output = "";
            _output += "<div>";
